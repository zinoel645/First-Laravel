                ...
                <div class="owl-carousel owl-theme">
                    <div class="item position-relative">
                        <div class="card h-100">
                            <a href=""><img src="" class="card-img-top" height="100%" width="100%"
                                    alt="Laptop" /></a>
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3 flex-column">
                                    <h6 class="mb-0 product-view"></h6>
                                    <h6 class="text-dark mb-0 product-view">Price: $</h6>
                                </div>

                                <div class="d-flex justify-content-between mb-2">
                                    <p class="text-muted mb-0">Available: <span class="fw-bold"></span>
                                    </p>
        ...
        <div class="row">
            <div class="col-12 my-2 col-md-6 fade-in-left animation-element animate">
                <a
                    ...
                    <img src="{{ asset('storage/homepage/small_banner1.jpg') }}" alt="" class="rounded-2" width="100%"
                        height="150px" style="object-fit: cover; object-position:center;">
                </a>
            </div>
            <div class="col-12 my-2 col-md-6 fade-in-right animation-element animate">
                <a href="./expertcorner.php">
                    <img src="{{ asset('storage/homepage/small_banner2.jpg') }}" alt="" class="rounded-2" width="100%"
                        height="150px" style="object-fit: cover; object-position:top;">
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="nav nav-pills mb-3 justify-content-around d-sm-flex flex-nowrap" id="pills-tab"
                        role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home"
                                aria-selected="true" name="category" onclick="category_main('wall')">Wall Ceramic
                                Tiles</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-profile" type="button" role="tab"
                                aria-controls="pills-profile" aria-selected="false" name="category"
                                onclick="category_main('floor')">Floor Ceramic Tiles</button>
                        </li>
                    </ul>
            ...
            <div class="item">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="" alt="" class="blog-img-fixed img-background">
                    </div>
                </div>
            </div>
