...
@section('admin_content')
    <div class="container">
        ...
        <form action="{{ route('blog.update', $each) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ $each->title }}">
                        @if ($errors->has('title'))
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="content" id="content" cols="60" rows="80">{{ $each->content }}</textarea>
